...
class BukuModel {
	...
	{
		$this->db->query("SELECT buku.*, kategori.nama_kategori FROM " . $this->table . " JOIN kategori ON kategori.id = buku.kategori_id WHERE buku.id=:id");
		$this->db->bind('id', $id);
	...
	// Tambahan metode untuk mendapatkan semua kategori
